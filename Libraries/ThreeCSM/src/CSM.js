...
class CSM {
    ...
    this.ShadowBiases = data.ShadowBiases || [-0.000035, -0.00011, -0.00025, -0.00075, -0.001];
	...
	createLights() {
      ...
      //console.error(this.breaks);
			light.shadow.bias = [-0.000035, -0.00011, -0.00025, -0.00075][i];//-0.000035 * (this.breaks[i] / this.breaks[0]);//[-0.000035, -0.000, -10, -10, 0, 0, 0, 0, 0, 0][i];
      //light.shadow.bias = this.ShadowBiases[i];
